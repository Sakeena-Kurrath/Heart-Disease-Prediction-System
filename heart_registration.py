...
l1 = tk.Label(window, text="Registration Form", font=("Helvetica Neue", 30, "bold"), bg="#4CAF50", fg="white")
l1.place(x=190, y=50)

# that is for label1 registration

l2 = tk.Label(window, text="Full Name :", width=12, font=("Helvetica Neue", 15, "bold"), bg="snow")
...
l3 = tk.Label(window, text="Address :", width=12, font=("Helvetica Neue", 15, "bold"), bg="snow")
...
l5 = tk.Label(window, text="E-mail :", width=12, font=("Helvetica Neue", 15, "bold"), bg="snow")
l5.place(x=130, y=250)
t4 = tk.Entry(window, textvar=Email, width=20, font=('', 15))
t4.place(x=330, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=12, font=("Helvetica Neue", 15, "bold"), bg="snow")
l6.place(x=130, y=300)
t5 = tk.Entry(window, textvar=Phoneno, width=20, font=('', 15))
t5.place(x=330, y=300)
# phone number
l7 = tk.Label(window, text="Gender :", width=12, font=("Helvetica Neue", 15, "bold"), bg="snow")
...
l8 = tk.Label(window, text="Age :", width=12, font=("Helvetica Neue", 15, "bold"), bg="snow")
l8.place(x=130, y=400)
t6 = tk.Entry(window, textvar=age, width=20, font=('', 15))
t6.place(x=330, y=400)

l4 = tk.Label(window, text="User Name :", width=12, font=("Helvetica Neue", 15, "bold"), bg="snow")
...
btn = tk.Button(window, text="Register", bg="#4CAF50",font=("Helvetica Neue",20),fg="white", width=9, height=1, command=insert)
